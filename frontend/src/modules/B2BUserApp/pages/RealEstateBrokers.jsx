                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 relative group">
                            ...
                            <input
                                type="text"
                                placeholder="Search areas or brokers..."
                                value={searchQuery}
                        ...
                        >
                            <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-black text-[10px] uppercase tracking-[0.2em] text-gray-900 leading-none mb-1">Filter Brokers</h3>
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Refine expert list</p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => setIsMobileFilterOpen(false)}
