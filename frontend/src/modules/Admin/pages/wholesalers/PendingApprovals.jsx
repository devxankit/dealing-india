...
const WholesalerPendingApprovals = () => {
    ...
    const columns = [
        { key: "companyName", label: "Wholesaler Name", render: (val) => <span className="font-bold text-gray-800">{val}</span> },
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div>
                ...
                <p className="text-gray-500">Review and verify new wholesaler applications.</p>
            </div>
...
export default WholesalerPendingApprovals;
