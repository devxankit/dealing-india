...
const DisputeResolution = () => {
    const [disputes] = useState([
        { _id: '1', vendor: 'Urban Fashion', wholesaler: 'Global Wholesale Hub', subject: 'Quality Mismatch', status: 'Open', date: '2023-11-20' },
        { _id: '2', vendor: 'Tech Hub', wholesaler: 'TechFlow Electronics', subject: 'Late Delivery', status: 'Resolved', date: '2023-11-15' },
    ]);
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500">Manage and resolve issues between vendors and wholesalers.</p>
                </div>
