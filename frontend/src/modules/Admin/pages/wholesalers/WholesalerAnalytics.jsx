...
const AdminWholesalerAnalytics = () => {
    const [period, setPeriod] = useState("this_month");

    const metrics = [
        { label: "Total Wholesalers", value: "154", trend: "+12", icon: FiUsers, color: "blue" },
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Wholesaler Analytics</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm h-80 flex flex-col">
                    <h3 className="font-bold text-gray-800 mb-6">Wholesaler Onboarding Trend</h3>
...
export default AdminWholesalerAnalytics;
