...
import { FiTruck, FiPackage, FiTrendingUp, FiSearch, FiCalendar, FiX } from "react-icons/fi";
    ...
    return (
        ...
        >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Shipped Orders</h1>
                    <p className="text-sm sm:text-base text-gray-600">Orders currently in transit</p>
                </div>
            </div>
