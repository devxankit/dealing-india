...
const B2BVendorCommunicationLogs = () => {
    const [logs] = useState([
        { _id: '1', vendor: 'Urban Fashion', b2bVendor: 'Global Wholesale Hub', lastMessage: 'Interested in bulk cotton shirts', date: '2023-11-20 10:30' },
        { _id: '2', vendor: 'Tech Hub', b2bVendor: 'TechFlow Electronics', lastMessage: 'What is the MOQ for earbuds?', date: '2023-11-20 09:15' },
    ]);
...
export default B2BVendorCommunicationLogs;
