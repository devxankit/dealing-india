                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                    <span className="px-2 py-0.5 bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-widest rounded">
                                        {product.brandName || 'Brand Not specified'}
                                    </span>
                                </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8">
                            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100/50">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="font-bold text-gray-900 text-sm uppercase tracking-tighter">
                                        {product.stock?.replace('_', ' ') || 'N/A'}
                                    </p>
                                </div>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100/50">
                                ...
                                <p className="font-bold text-gray-900 text-lg">
                                    {product.stockQuantity || 0} <span className="text-xs font-medium text-gray-400">Items</span>
                                </p>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100/50">
                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Min. Order Qty</p>
                                <p className="font-bold text-gray-900 text-lg">
                                    {product.minimumOrderQuantity || 1} <span className="text-xs font-medium text-gray-400">{product.unit || 'Items'}</span>
                                </p>
                            </div>
                        </div>
