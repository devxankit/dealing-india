    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900">Hero Banner Payments</h1>
            <p className="text-gray-500 text-sm font-medium">Manage and track all Hero Banner booking transactions</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        >
          ...
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Total Banner Revenue</p>
        ...
        >
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <p className="text-xs text-gray-500 font-medium">
              from {revenueStats.uniqueVendorsCount || 0} {revenueStats.uniqueVendorsCount === 1 ? 'vendor' : 'vendors'}
            </p>
          </div>
        </motion.div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50/50">
                ...
                <th className="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">Vendor / Entity</th>
                    ...
                    >
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-black text-gray-900 text-sm">Banner Booking Payment</p>
                      ...
                      <td className="px-8 py-6 text-center">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-xl">
                          ...
                          <span className="text-xs font-bold text-gray-700">{txn.vendor || 'Unknown Vendor'}</span>
                        </div>
                      </td>
                      <td className="px-8 py-6 text-center">
                    ...
                    <tr>
                      <td colSpan="4" className="px-8 py-20 text-center">
                        <div className="flex flex-col items-center gap-4 opacity-20">
                          <FiInfo size={48} />
                          <p className="text-lg font-black text-gray-900 uppercase tracking-widest">No Records Found</p>
                        </div>
                      </td>
                    </tr>
                  )}
