...
import ReviewItem from '../../../shared/components/Product/ReviewItem';
import SocialShare from '../../../shared/components/Product/SocialShare';
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        if (productData) {
          console.log('API Product Data:', productData); // Debugging Brand Issue
          ...
          const transformedProduct = {
            ...
            brandName: (productData.brandId && typeof productData.brandId === 'object') ? productData.brandId.name : (productData.brandName || null),
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div className="flex flex-col">
                  <div className="mb-6">
                    ...
                    {/* Unit */}
                    <p className="text-gray-600 mb-6 flex items-center gap-4">
                      <span>Unit: <span className="font-medium text-gray-800">{product.unit}</span></span>
                      {product.brandName && (
                        <>
                          <span className="w-1.5 h-1.5 rounded-full bg-gray-300"></span>
                          <span>Brand: <span className="font-medium text-gray-800">{product.brandName}</span></span>
                        </>
                      )}
                    </p>
                  </div>
