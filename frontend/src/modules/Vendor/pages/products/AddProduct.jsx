...
const AddProduct = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    brandName: "",
    isManualBrand: false,
    sizeVariants: [], // Root level size variants with prices and stock
  });
      ...
      const productData = {
        ...
        sizes: formData.hasSizes
          ? (formData.sizeVariants.length > 0
            ...
            : (formData.sizes || []))
          : [],
        sizeVariants: formData.hasSizes && formData.sizeVariants.length > 0
      ...
      <form
        ...
        {currentStep === 2 && (
          <>
            ...
            {/* Root Size Variants Section - Only show if hasSizes is true */}
            {formData.hasSizes && (
              <div className="mb-8 bg-white p-4 rounded-xl border border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-sm font-bold text-gray-800">Main Product Sizes</h3>
            ...
            <div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2">
                  <h3 className="text-sm font-bold text-gray-800">Color Variants</h3>
                  <span className="text-[10px] px-2 py-0.5 bg-gray-100 text-gray-500 rounded-full font-medium uppercase tracking-wider">Optional</span>
                </div>
                <button
                  type="button"
