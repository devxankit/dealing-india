                ...
                <div className="absolute -bottom-12 left-10 flex items-end gap-6">
                    <div className="w-40 h-40 rounded-3xl bg-white p-2 shadow-xl border-4 border-white overflow-hidden">
                        <div className="w-full h-full bg-slate-100 rounded-2xl flex items-center justify-center">
                            <span className="text-4xl font-black text-primary-600">W</span>
                        </div>
                    </div>
                    <div className="mb-14">
                        <h1 className="text-3xl font-black text-white flex items-center gap-2 drop-shadow-md">
                            {wholesaler?.companyName || "Global Wholesale Hub"}
                            <FiCheckCircle className="text-white fill-green-500 text-xl" />
                        </h1>
                        <p className="text-white/90 font-medium drop-shadow-sm">Verified Gold Batch Wholesaler</p>
                    </div>
                </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 text-gray-600">
                                ...
                                <span className="text-sm font-medium">{wholesaler?.email || "sales@globalhub.com"}</span>
                            </div>
                            <div className="flex items-center gap-3 text-gray-600">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            We are a leading wholesaler specializing in high-quality fashion and lifestyle products.
