...
const Products = () => {
    ...
    const menuItems = [
        {
            path: "/wholesaler/products/manage-products",
            ...
            description: "View and manage your wholesalers listings",
        },
        {
            path: "/wholesaler/products/add-product",
            label: "Add Product",
            icon: FiPlus,
            ...
            description: "List a new product for vendors",
        },
    ];
