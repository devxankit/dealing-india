...
const ManageProducts = () => {
    ...
    const [products, setProducts] = useState([
        { _id: '1', name: 'Cotton T-Shirts Bulk', price: 250, stockQuantity: 500, category: 'Clothing', visibility: 'Visible' },
        { _id: '2', name: 'Wireless Earbuds', price: 800, stockQuantity: 200, category: 'Electronics', visibility: 'Visible' },
    ]);
        ...
        },
        {
            ...
            render: (_, row) => (
                <div className="flex items-center gap-2">
                    <button onClick={() => navigate(`/wholesaler/products/edit/${row._id}`)} className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg">
                        <FiEdit />
                    </button>
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <button onClick={() => navigate("/wholesaler/products/add-product")} className="flex items-center gap-2 px-5 py-2.5 bg-primary-600 text-white rounded-xl font-bold hover:bg-primary-700 transition-all shadow-md">
